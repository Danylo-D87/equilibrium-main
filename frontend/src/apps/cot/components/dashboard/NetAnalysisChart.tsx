            ...
            <div className="h-[20%] w-full">
                <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={chartData} margin={MARGIN} syncId="netAnalysis">
                        ...
                        <Area yAxisId="pos" type="monotone" dataKey="position" stroke={side === 'long' ? D.specLine : D.extremeLong} fill={side === 'long' ? 'rgba(59,130,246,0.08)' : 'rgba(239,68,68,0.08)'} strokeWidth={1.5} dot={false} />
                    </ComposedChart>
                </ResponsiveContainer>
            </div>
            ...
            <div className="h-[10%] w-full">
                <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={chartData} margin={MARGIN_NARROW} syncId="netAnalysis">
                        ...
                        <ReferenceLine yAxisId="z" y={0} stroke="#333" />
                        ...
                        <Area yAxisId="z" type="monotone" dataKey="zScore" stroke={D.specLine} fill="rgba(59,130,246,0.06)" strokeWidth={1.2} dot={false} connectNulls />
                    </ComposedChart>
                </ResponsiveContainer>
            </div>
        </div>
